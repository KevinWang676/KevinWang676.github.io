...
layout: splash
title: "Qixuan Wang"
excerpt: "M.S. in AI @ Northwestern (Dec 2025). AI for batteries, agentic LLM systems, diffusion & speech. Applying for PhD positions."
...
feature_row:
  - icon: "fas fa-robot"
    title: "AI for Battery Research Agents"
    excerpt: "A full-stack multi-agent system with RAG to reason over battery papers, organize knowledge, and support decision-making."
    url: "/portfolio/ai-battery-research-agents/"
    btn_label: "Read More"
    btn_class: "btn--primary"
  - icon: "fas fa-microphone-alt"
    title: "Generative Speech (TTS)"
    excerpt: "Bark Voice Cloning: one-click training/inference + Gradio UI for rapid voice cloning. **3,000+ GitHub stars**."
    url: "/portfolio/bark-voice-cloning/"
    btn_label: "Read More"
    btn_class: "btn--primary"
  - icon: "fas fa-rocket"
    title: "DoingDream AI"
    ...
    <div class="home-hero__grid">
      <div class="home-hero__copy">
        ...
        <div class="home-hero__cta">
          <a class="btn btn--primary btn--large" href="{{ base_path }}/cv/"><i class="fas fa-file-alt"></i> CV</a>
          <a class="btn btn--inverse btn--large" href="{{ base_path }}/portfolio/"><i class="fas fa-code"></i> Projects</a>
          <a class="btn btn--inverse btn--large" href="{{ base_path }}/publications/"><i class="fas fa-book"></i> Publications</a>
        </div>

        <div class="home-hero__meta">
          <a class="home-hero__meta-item" href="mailto:qixuanwang2025@u.northwestern.edu">
            <i class="fas fa-envelope"></i><span>Email</span>
          </a>
          <a class="home-hero__meta-item" href="https://github.com/KevinWang676">
            <i class="fab fa-github"></i><span>GitHub</span>
          </a>
          <a class="home-hero__meta-item" href="https://www.linkedin.com/in/qixuan-wang-91504632b">
            <i class="fab fa-linkedin"></i><span>LinkedIn</span>
          </a>
          <span class="home-hero__meta-item is-muted">
            <i class="fas fa-map-marker-alt"></i><span>Evanston, IL</span>
          </span>
        </div>

        <div class="home-hero__stats" role="list" aria-label="Quick stats">
      ...
      <aside class="home-hero__card" aria-label="Snapshot">
        <div class="home-hero__photo">
          <img src="{{ base_path }}/images/qixuan.jpg" alt="Portrait of Qixuan Wang" loading="eager">
        </div>
